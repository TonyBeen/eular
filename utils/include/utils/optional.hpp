...
//
// Documentation available at https://eular.tartanllama.xyz/
//
...
#define TL_OPTIONAL_IS_TRIVIALLY_COPY_CONSTRUCTIBLE(T) \
    eular::detail::is_trivially_copy_constructible<T>::value
...
// in some cases. This is a check to workaround the common failing case.
        ...
        // Trait for checking if a type is a eular::optional
        template <class T>
        ...
        // Change void to eular::monostate
        template <class U>
...
namespace std
{
    // TODO SFINAE
    template <class T>
    struct hash<eular::optional<T>>
    {
        ::std::size_t operator()(const eular::optional<T> &o) const
        {
            if (!o.has_value())
                return 0;

            return std::hash<eular::detail::remove_const_t<T>>()(*o);
        }
    };
} // namespace std
