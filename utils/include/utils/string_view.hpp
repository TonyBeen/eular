...
namespace eular { namespace sv_lite {
...
# endif
    ...
    nssv_constexpr14 const_reference at( size_type pos ) const
    {
        ...
        if ( pos >= size() )
        {
            throw std::out_of_range("eular::string_view::at()");
        }
#endif
        return data_at( pos );
    }
    ...
    size_type copy( CharT * dest, size_type n, size_type pos = 0 ) const
    {
        ...
        if ( pos > size() )
        {
            throw std::out_of_range("eular::string_view::copy()");
        }
#endif
    ...
    nssv_constexpr14 basic_string_view substr( size_type pos = 0, size_type n = npos ) const
    {
        ...
        if ( pos > size() )
        {
            throw std::out_of_range("eular::string_view::substr()");
        }
#endif
...
nssv_constexpr eular::sv_lite::string_view operator""sv( const char* str, size_t len ) nssv_noexcept  // (1)
{
    return eular::sv_lite::string_view{ str, len };
}

nssv_constexpr eular::sv_lite::u16string_view operator""sv( const char16_t* str, size_t len ) nssv_noexcept  // (2)
{
    return eular::sv_lite::u16string_view{ str, len };
}

nssv_constexpr eular::sv_lite::u32string_view operator""sv( const char32_t* str, size_t len ) nssv_noexcept  // (3)
{
    return eular::sv_lite::u32string_view{ str, len };
}

nssv_constexpr eular::sv_lite::wstring_view operator""sv( const wchar_t* str, size_t len ) nssv_noexcept  // (4)
{
    return eular::sv_lite::wstring_view{ str, len };
}
...
nssv_constexpr eular::sv_lite::string_view operator""_sv( const char* str, size_t len ) nssv_noexcept  // (1)
{
    return eular::sv_lite::string_view{ str, len };
}

nssv_constexpr eular::sv_lite::u16string_view operator""_sv( const char16_t* str, size_t len ) nssv_noexcept  // (2)
{
    return eular::sv_lite::u16string_view{ str, len };
}

nssv_constexpr eular::sv_lite::u32string_view operator""_sv( const char32_t* str, size_t len ) nssv_noexcept  // (3)
{
    return eular::sv_lite::u32string_view{ str, len };
}

nssv_constexpr eular::sv_lite::wstring_view operator""_sv( const wchar_t* str, size_t len ) nssv_noexcept  // (4)
{
    return eular::sv_lite::wstring_view{ str, len };
}
...
}}} // namespace eular::literals::string_view_literals
...
//
// make types and algorithms available in namespace eular:
//
...
template<>
struct hash< eular::string_view >
{
public:
    std::size_t operator()( eular::string_view v ) const nssv_noexcept
    {
...
template<>
struct hash< eular::wstring_view >
{
public:
    std::size_t operator()( eular::wstring_view v ) const nssv_noexcept
    {
...
template<>
struct hash< eular::u16string_view >
{
public:
    std::size_t operator()( eular::u16string_view v ) const nssv_noexcept
    {
...
template<>
struct hash< eular::u32string_view >
{
public:
    std::size_t operator()( eular::u32string_view v ) const nssv_noexcept
    {
