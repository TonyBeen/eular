...
TEST_CASE("traffic material matches the versioned key schedule vector", "[crypto]")
{
    std::array<uint8_t, UTP_CRYPTO_X25519_KEY_SIZE>        shared_secret                 = {};
    ...
    const std::array<uint8_t, UTP_CRYPTO_AES_256_KEY_SIZE> expected_client_to_server_key = {
        0x2e, 0x00, 0x57, 0x42, 0x88, 0xf5, 0x90, 0xe0, 0x88, 0x8a, 0xa4, 0xea, 0x06, 0xb0, 0x20, 0x8b,
        0xb4, 0xf0, 0x72, 0x30, 0x59, 0xd1, 0x1e, 0x91, 0xab, 0x0a, 0xa0, 0x98, 0x9c, 0x72, 0x4a, 0x61,
    };
    ...
    const std::array<uint8_t, UTP_CRYPTO_AES_256_KEY_SIZE> expected_server_to_client_key = {
        0xef, 0x78, 0xb5, 0xf1, 0xd3, 0xd7, 0x04, 0x55, 0x91, 0xb9, 0x25, 0x38, 0x54, 0x71, 0xa9, 0x61,
        0xdb, 0xf3, 0x55, 0x1b, 0xad, 0x43, 0x59, 0x56, 0x96, 0x56, 0x52, 0x73, 0x60, 0xfd, 0xf7, 0x83,
    };
