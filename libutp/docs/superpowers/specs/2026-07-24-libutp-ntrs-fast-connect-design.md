...
已定稿:**#1(方向/cid 归并/反向提升)、#2(对称/回观测源)、#3(单 cid 去重)、#12(host-local/hairpinning,见 §6.6)、#4/#5(反射/放大缓解,见 §12)、#8(MTU/候选上限,见 §6.7)、#7(取消/半开清理/资源上限,见 §6.8)**。
...
下一步优先:**#9(加密 Finished 在打洞下的重传)**,随后 #10/#6/#11。
